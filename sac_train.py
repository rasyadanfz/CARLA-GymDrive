...
def main():
    ...
    n = "end2end"
    model.save(f"checkpoints/sac/sac_sb3_{n}_{NUM_EPISODES}_final")

    eval_list, episodes_list = eval_callback.get_results()

    with open(f"sac_{n}_{NUM_EPISODES}_last_execution.txt", "w") as f:
