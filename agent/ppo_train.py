...
from ppo_architecture import CustomExtractor_PPO_End2end, CustomExtractor_PPO_Modular
...
def make_env():
    env = gym.make('carla-rl-gym-v0', time_limit=60, initialize_server=True, random_weather=False, synchronous_mode=True, continuous=True, show_sensor_data=False, has_traffic=False, verbose=False)
